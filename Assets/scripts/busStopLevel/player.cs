...
public class player : MonoBehaviour
{
    ...
    public int lives = 3;
    public bool isGrounded = false; // Know if the player is touching the ground or not.
    public bool isMoving = false; // Know if the player is moving or not.
    public float speed = 5f; // speed with which the player can move.
    public float jumpForce = 3f; // The force with which the player can jump.
